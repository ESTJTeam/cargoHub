...
public class SlackController {
     ...
     *
     * @param id 삭제할 Slack 로그의 UUID
     * @return status RESTORED 반환
     */
    @PatchMapping("/logs/{id}")
    public BaseResponse<Void> restoreSlackLog(@PathVariable("id") UUID id) {

        slackService.restoreSlackLog(id);

        return BaseResponse.ok(BaseStatus.RESTORED);
    }
}
